...
| :--- | :--- |
| App Store | https://apps.apple.com/it/app/radio-teate-on-air/id6753764457 |
...
1.  **Clonazione:** Clona il repository sulla tua macchina locale:
    ```bash
    git clone https://github.com/lorenzus-jpeg/radioteateonair-app-ios.git
    ```
2.  **Navigazione:** Entra nella cartella del progetto:
    ```bash
    cd [IlTuoRepo]
    ```
3.  **Configurazione:** Apri il progetto in XCode. Assicurati che il tuo ambiente rispetti i requisiti di OS.
4.  **Esecuzione:** Avvia l'app su un emulatore o un dispositivo fisico.
...
Per collaborare al progetto scrivere una mail con oggetto "RICHIESTA COLLABORAZIONE APP iOS" all'indirizzo mail: _info@radioteateonair.it_
